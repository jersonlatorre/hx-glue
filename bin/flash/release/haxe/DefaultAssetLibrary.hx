...
@:keep @:dox(hide) class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		classTypes.set (id, __ASSET__img_background_game_png);
		types.set (id, AssetType.IMAGE);
		#end
		id = "img/circle_idle.json";
		#if html5
		preload.set (id, true);
		#elseif (desktop || cpp || flash)
		classTypes.set (id, __ASSET__img_circle_idle_json);
		types.set (id, AssetType.TEXT);
		#end
		id = "img/circle_idle.png";
		#if html5
		preload.set (id, true);
		#elseif (desktop || cpp || flash)
		classTypes.set (id, __ASSET__img_circle_idle_png);
		types.set (id, AssetType.IMAGE);
		#end
...
@:keep @:bind #if display private #end class __ASSET__img_circle_idle_json extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__img_circle_idle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/img/circle_idle.json") #if display private #end class __ASSET__img_circle_idle_json extends haxe.io.Bytes {}@:image("assets/img/circle_idle.png") #if display private #end class __ASSET__img_circle_idle_png extends lime.graphics.Image {}
