...
import haxe.Timer;
import glue.display.BitmapText;
...
{
	private var labelFPS:BitmapText;
	private var textFPS:BitmapText;
	private var labelMEM:BitmapText;
	private var textMEM:BitmapText;
